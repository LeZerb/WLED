...
*/
#include "my_config_wifi.h"

#define MAX_LEDS 150       // Maximum total LEDs. More than 1500 might create a low memory situation on ESP8266.
#define MDNS_NAME "wled-clock"    // mDNS hostname, ie: *.local
